...
| WROOM production firmware (`firmware/wroom_production/wroom_production.ino`) | compile-verified 2026-09-15 (1,089,976 B / 83 % flash, 49,280 B / 15 % RAM; `esp32:esp32:esp32`) | **COMPILED ONLY — NOT FLASHED**; dry-run default; production `/webhook` paths require the workflow ACTIVE (or editor test mode) |
